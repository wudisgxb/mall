...
function Alipay(opts) {
    ...
    this.return_url = opts.return_url
...
/**
 * https://doc.open.alipay.com/docs/api.htm?docType=4&apiId=1322
 * 查询转账订单接口
 * @param {Object} opts
 * @param {String} opts.out_biz_no         商户转账唯一订单号。
...
props.signVerify = function (response) {
    ...
    return util.signVerify(tmp.unencode, sign, this.rsaPublic, this.signType);
}
...
props.query = function (opts) {
    ...
    var body = util.processParams(params, this.rsaPrivate, this.signType);
